...
async function main() {
    console.log("🚀 Deploying Contracts with Debug Events...\n");
    ...
    try {
        console.log("🔍 Step 1: Deploying AerodromeAdapter with debug events...");
        ...
        console.log("\n🔍 Step 2: Deploying CreditLineFactory with debug events...");
        ...
        console.log("\n🔍 Step 5: Creating credit line via factory (with debug events)...");
